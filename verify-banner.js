...
async function verifyFullConsentLifecycle() {
    ...
    try {
        ...
        // FIX: Wrapped inside a try/catch promise array block to completely skip timeout crashes
        ...
        if (bannerFound) {
            ...
            // Check if site layout bypassed the banner because consent payload storage is already active
